    ...
    return TextButton(
        ...
        child: Column(
          ...
          children: [
            ...
            Padding(padding: const EdgeInsets.only(left: 77), child: Text("${video.channel.name} . ${video.viewsCount} views", style: const TextStyle(color: Color.fromARGB(85, 165, 161, 161)),),)
          ],
        ));
  }
